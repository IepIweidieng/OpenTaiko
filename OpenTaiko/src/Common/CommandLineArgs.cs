...
internal sealed class CommandLineArgs {
	...
	public static CommandLineArgs Parse(string[] args) {
		...
		if (Get(args, "--clip-volume") is string value && bool.TryParse(value, out bool clipVolume))
			cli.ClipVolume = clipVolume;
		else
			cli.ClipVolumeError = "--clip-volume must be true or false (case-insensitive).";
